...
SERVICE_NAME = "onboarding-relevance-fresh-07"
PEERS: tuple[Peer, ...] = (
    Peer("avior-test-ob-org/onboarding-relevance-fresh-08", "FRESH_08_URL"),
    Peer("avior-test-ob-org/onboarding-relevance-fresh-09", "FRESH_09_URL"),
)
